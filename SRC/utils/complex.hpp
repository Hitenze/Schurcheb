#ifndef SCHURCHEB_COMPLEX_H
#define SCHURCHEB_COMPLEX_H
...
#pragma omp declare reduction(+:complexd:omp_out += omp_in) initializer (omp_priv=complexd())
    ...
    */
   template <class T> struct SchurchebIsComplex : public std::false_type {};
   template <class T> struct SchurchebIsComplex<const T> : public SchurchebIsComplex<T> {};
   template <class T> struct SchurchebIsComplex<volatile const T> : public SchurchebIsComplex<T>{};
   template <class T> struct SchurchebIsComplex<volatile T> : public SchurchebIsComplex<T>{};
   template<> struct SchurchebIsComplex<complexs> : public std::true_type {};
   template<> struct SchurchebIsComplex<complexd> : public std::true_type {};
   
   /**
    * @brief   Tell if a value is a real value.
    * @details Tell if a value is a real value.
    */
   template <class T> struct SchurchebIsReal : public std::false_type {};
   template <class T> struct SchurchebIsReal<const T> : public SchurchebIsReal<T> {};
   template <class T> struct SchurchebIsReal<volatile const T> : public SchurchebIsReal<T>{};
   template <class T> struct SchurchebIsReal<volatile T> : public SchurchebIsReal<T>{};
   template<> struct SchurchebIsReal<float> : public std::true_type {};
   template<> struct SchurchebIsReal<double> : public std::true_type {};
