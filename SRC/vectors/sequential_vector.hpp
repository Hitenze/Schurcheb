#ifndef SCHURCHEB_SEQUENTIAL_VECTOR_H
#define SCHURCHEB_SEQUENTIAL_VECTOR_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<SequentialVectorClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<SequentialVectorClass<complexd> > : public std::true_type {};
