#ifndef SCHURCHEB_INT_VECTOR_H
#define SCHURCHEB_INT_VECTOR_H
...
namespace schurcheb
{
   ...
   private:
      ...
      * @details Tell if this vector allocates memory. If set to false, the memory will not be freed when deallocate.
      */
      bool           _hold_data;
      
      /**
      * @brief   The location of data.
      * @details The location of data.
      */
      int            _location;
   ...
   typedef IntVectorClass<SCHURCHEB_long>    vector_SCHURCHEB_long;
   template<> struct SchurchebIsComplex<IntVectorClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<IntVectorClass<complexd> > : public std::true_type {};
