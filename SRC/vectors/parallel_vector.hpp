#ifndef SCHURCHEB_PARALLEL_VECTOR_H
#define SCHURCHEB_PARALLEL_VECTOR_H
...
namespace schurcheb
{
   ...
   public:
       ...
       * @return     Return error message.
       */
      int            Setup(int n_local, SCHURCHEB_long n_start, SCHURCHEB_long n_global, parallel_log &parlog);
       ...
       * @return     Return error message.
       */
      int            Setup(int n_local, SCHURCHEB_long n_start, SCHURCHEB_long n_global, bool setzero, parallel_log &parlog);
       ...
       * @return     Return error message.
       */
      int            Setup(int n_local, SCHURCHEB_long n_start, SCHURCHEB_long n_global, int location, bool setzero, parallel_log &parlog);
       ...
       * @return     Return error message.
       */
      int            Setup(int n_local, SCHURCHEB_long n_start, SCHURCHEB_long n_global, int reserve, int location, bool setzero, parallel_log &parlog);
       ...
       */
      virtual SCHURCHEB_long GetLengthGlobal() const;
       ...
       */
      virtual SCHURCHEB_long GetStartGlobal() const;
   ...
   template<> struct SchurchebIsComplex<ParallelVectorClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<ParallelVectorClass<complexd> > : public std::true_type {};
   template<> struct SchurchebIsParallel<ParallelVectorClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsParallel<ParallelVectorClass<complexd> > : public std::true_type {};
