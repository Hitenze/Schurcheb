#ifndef SCHURCHEB_VECTOR_H
#define SCHURCHEB_VECTOR_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<VectorVirtualClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<VectorVirtualClass<complexd> > : public std::true_type {};
   ...
   public:
       ...
       * @return     Return the length of the vector.
       */
      virtual SCHURCHEB_long GetLengthGlobal() const = 0;
       ...
       */
      virtual SCHURCHEB_long GetStartGlobal() const = 0;
   ...
   template<> struct SchurchebIsComplex<VectorClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<VectorClass<complexd> > : public std::true_type {};
