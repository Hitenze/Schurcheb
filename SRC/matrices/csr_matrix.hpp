#ifndef SCHURCHEB_CSR_MATRIX_H
#define SCHURCHEB_CSR_MATRIX_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<CsrMatrixClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<CsrMatrixClass<complexd> > : public std::true_type {};
