#ifndef SCHURCHEB_COO_MATRIX_H
#define SCHURCHEB_COO_MATRIX_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<CooMatrixClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<CooMatrixClass<complexd> > : public std::true_type {};
