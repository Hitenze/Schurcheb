#ifndef SCHURCHEB_PARALLEL_CSR_MATRIX_H
#define SCHURCHEB_PARALLEL_CSR_MATRIX_H
...
namespace schurcheb
{
   ...
   private:
       ...
       */
      vector_SCHURCHEB_long      _offd_map_v;
   ...
   public:
       ...
       */
      typename std::conditional<SchurchebIsDoublePrecision<T>::value, 
                                 double, 
       ...
       * @return     Return error message.
       */
      int            Setup(int nrow_local, SCHURCHEB_long nrow_start, SCHURCHEB_long nrow_global, int ncol_local, SCHURCHEB_long ncol_start, SCHURCHEB_long ncol_global, parallel_log &parlog);
       ...
       */
      SCHURCHEB_long GetNumRowsGlobal() const;
       ...
       */
      SCHURCHEB_long GetNumColsGlobal() const;
       ...
       */
      SCHURCHEB_long GetRowStartGlobal() const;
       ...
       */
      SCHURCHEB_long GetColStartGlobal() const;
       ...
       * @return     Return error message.
       */
      int            GetGraphArrays( vector_SCHURCHEB_long &vtxdist, vector_SCHURCHEB_long &xadj, vector_SCHURCHEB_long &adjncy);
       ...
       */
      vector_SCHURCHEB_long&        GetOffdMap();
       ...
       * @return           Return error message.                                                                                                                                                
       */
      int            SubMatrix(vector_SCHURCHEB_long &rows, vector_SCHURCHEB_long &cols, int location, ParallelCsrMatrixClass<T> &parcsrmat_out);
   ...
   template<> struct SchurchebIsComplex<ParallelCsrMatrixClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<ParallelCsrMatrixClass<complexd> > : public std::true_type {};
   template<> struct SchurchebIsParallel<ParallelCsrMatrixClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsParallel<ParallelCsrMatrixClass<complexd> > : public std::true_type {};
