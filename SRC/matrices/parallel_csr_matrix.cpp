...
namespace schurcheb
{
   ...
   CommunicationHelperClass::CommunicationHelperClass(const CommunicationHelperClass &comm_helper)
   {
      ...
      {
         SCHURCHEB_ERROR("Copy a communication helper that is working. Communication helper might be changed after this job, please use move instead.");
      }
   ...
   CommunicationHelperClass& CommunicationHelperClass::operator= (const CommunicationHelperClass &comm_helper)
   {
      ...
      if(comm_helper._is_waiting)
      {
         SCHURCHEB_ERROR("Using operator = on a communication helper that is working. Communication helper might be changed after this job, please use move instead.");
      }
      this->_location_send = comm_helper._location_send;
      this->_location_recv = comm_helper._location_recv;
      this->_buff_unit_size = comm_helper._buff_unit_size;
   ...
   int CommunicationHelperClass::Clear()
   {
      if(this->_is_waiting)
      {
         SCHURCHEB_ERROR("Tring to destroy a working communication helper.");
      ...
      {
         SCHURCHEB_FREE( this->_send_buff_v2[i], kMemoryHost );
      }
      std::vector<void*>().swap(this->_send_buff_v2);
      
      for(i = 0 ; i < this->_recv_buff_v2.size() ; i ++)
      {
         SCHURCHEB_FREE( this->_recv_buff_v2[i], kMemoryHost );
      }
      ...
      {
         SCHURCHEB_FREE( this->_send_buff_v2_d[i], kMemoryDevice );
      }
      std::vector<void*>().swap(this->_send_buff_v2_d);
      
      for(i = 0 ; i < this->_recv_buff_v2_d.size() ; i ++)
      {
         SCHURCHEB_FREE( this->_recv_buff_v2_d[i], kMemoryDevice );
      }
   ...
   int CommunicationHelperClass::CreateHostBuffer(int unitsize)
   {
      ...
      if( this->_buff_unit_size == 0 )
      {
         ...
         for(i = 0 ; i < nsends ; i ++)
         {
            ...
            SCHURCHEB_MALLOC_VOID( this->_send_buff_v2[i], new_size, kMemoryHost);
         }
         ...
         for(i = 0 ; i < nrecvs ; i ++)
         {
            ...
            new_size = unitsize * length;
            SCHURCHEB_MALLOC_VOID( this->_recv_buff_v2[i], new_size, kMemoryHost);
         }
      }
      else
      {
         ...
         for(i = 0 ; i < nsends ; i ++)
         {
            ...
            new_size = unitsize * length;
            SCHURCHEB_REALLOC_VOID( this->_send_buff_v2[i], old_size, new_size, kMemoryHost);
         }
         ...
         for(i = 0 ; i < nrecvs ; i ++)
         {
            ...
            old_size = this->_buff_unit_size * length;
            new_size = unitsize * length;
            SCHURCHEB_REALLOC_VOID( this->_recv_buff_v2[i], old_size, new_size, kMemoryHost);
         }
      }
   ...
   int CommunicationHelperClass::CreateDeviceBuffer(int unitsize)
   {
      ...
      if( this->_buff_d_unit_size == 0 )
      {
         ...
         for(i = 0 ; i < nsends ; i ++)
         {
            length = this->_send_idx_v2[i].GetLengthLocal();
            new_size = unitsize * length;
            SCHURCHEB_MALLOC_VOID( this->_send_buff_v2_d[i], new_size, kMemoryDevice);
         }
         ...
         for(i = 0 ; i < nrecvs ; i ++)
         {
            length = this->_recv_idx_v2[i].GetLengthLocal();
            new_size = unitsize * length;
            SCHURCHEB_MALLOC_VOID( this->_recv_buff_v2_d[i], new_size, kMemoryDevice);
         }
      }
      else
      {
         ...
         for(i = 0 ; i < nsends ; i ++)
         {
            ...
            new_size = unitsize * length;
            SCHURCHEB_REALLOC_VOID( this->_send_buff_v2_d[i], old_size, new_size, kMemoryDevice);
         }
         ...
         for(i = 0 ; i < nrecvs ; i ++)
         {
            ...
            old_size = this->_buff_d_unit_size * length;
            new_size = unitsize * length;
            SCHURCHEB_REALLOC_VOID( this->_recv_buff_v2_d[i], old_size, new_size, kMemoryDevice);
         }
      }
   ...
   int CommunicationHelperClass::DataTransferStart(const VectorVirtualClass<T> &vec_in, int loc_in)
   {
      if(!(this->_is_ready))
      {
         SCHURCHEB_ERROR("Communication helper not ready, please call SetupMatvec() function first.");
         return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
      }
      
      /* stop if some other communication is ongoing */
      SCHURCHEB_CHKERR(this->_is_waiting);
      this->_is_waiting = true;
      
      SCHURCHEB_CHKERR(vec_in.GetLengthLocal() != this->_n_in);
      
      int   i, j, nsends, nrecvs, unitsize, length;
      
      /* for integer, create integer vector, otherwise real vector */
      typename std::conditional<SchurchebIsInteger<T>::value, IntVectorClass<T>, SequentialVectorClass<T>>::type send_ptr;
      ...
      switch(loc_in)
      {
         ...
         case kMemoryDevice: case kMemoryUnified:
         {
            ...
            for(i = 0 ; i < nsends ; i ++)
            {
               ...
               this->_send_idx_v2[i].GatherPerm(vec_in, send_ptr);
               SCHURCHEB_MEMCPY(this->_send_buff_v2[i], this->_send_buff_v2_d[i], length, kMemoryHost, kMemoryDevice, T);
            }
         ...
         default:
         {
            ...
            SCHURCHEB_ERROR("Unknown memory location.");
      ...
      for(i = 0 ; i < nsends ; i ++)
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiIsend( (T*) (this->_send_buff_v2[i]), this->_send_idx_v2[i].GetLengthLocal(), 
                           this->_send_to_v[i], 0, comm, &(this->_requests_v[j++])) );
      }
      
      for(i = 0 ; i < nrecvs ; i ++)
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiIrecv( (T*) (this->_recv_buff_v2[i]), this->_recv_idx_v2[i].GetLengthLocal(),
   ...
   int CommunicationHelperClass::DataTransferOver(VectorVirtualClass<T> &vec_out, int loc_out)
   {
      ...
      SCHURCHEB_CHKERR(vec_out.GetLengthLocal() != this->_n_out);
      
      int   i, sendrecvs, nsends, nrecvs, idx, length;
      
      /* for integer, create integer vector, otherwise real vector */
      typename std::conditional<SchurchebIsInteger<T>::value, IntVectorClass<T>, SequentialVectorClass<T>>::type recv_ptr;
      ...
      switch(loc_out)
      {
         case kMemoryHost: case kMemoryPinned:
         {
            ...
            for(i = 0 ; i < sendrecvs ; i ++)
            {
               ...
               SCHURCHEB_MPI_CALL( MPI_Waitany( sendrecvs, this->_requests_v.data(), &idx, MPI_STATUSES_IGNORE) );
               if(idx >= nsends)
               {
         ...
         case kMemoryDevice: case kMemoryUnified:
         {
            ...
            for(i = 0 ; i < sendrecvs ; i ++)
            {
               ...
               if(idx >= nsends)
               {
                  ...
                  length = this->_recv_idx_v2[idx].GetLengthLocal();
                  /* copy to device */
                  SCHURCHEB_MEMCPY(this->_recv_buff_v2_d[idx], this->_recv_buff_v2[idx], length, kMemoryDevice, kMemoryHost, T);
   ...
   int CommunicationHelperClass::DataTransferStart(const std::vector<VectorType> &vec_in, int loc_in)
   {
      ...
      SCHURCHEB_CHKERR((int)(vec_in.size()) != nsends);
      ...
      for(i = 0 ; i < nsends ; i ++)
      {
         ...
         SCHURCHEB_MEMCPY( this->_send_buff_v2[i], vec_in[i].GetData(), this->_send_idx_v2[i].GetLengthLocal(), kMemoryHost, loc_in, T);
   ...
   int CommunicationHelperClass::DataTransferOver(std::vector<VectorType> &vec_out, int loc_out)
   {
      ...
      /* now check the size, location of the input data */
      SCHURCHEB_CHKERR((int)(vec_out.size()) != nrecvs);
      ...
      for(i = 0 ; i < sendrecvs ; i ++)
      {
         ...
         if(idx >= nsends)
         {
             ...
             */
            idx -= nsends;
            SCHURCHEB_MEMCPY( vec_out[idx].GetData(), this->_recv_buff_v2[idx], this->_recv_idx_v2[idx].GetLengthLocal(), loc_out, kMemoryHost, T);
         } 
      }
   ...
   int CommunicationHelperClass::DataTransferStartReverse(const VectorVirtualClass<T> &vec_in, int loc_in)
   {
      ...
      SCHURCHEB_CHKERR(vec_in.GetLengthLocal() != this->_n_out);
      ...
      switch(loc_in)
      {
         ...
         case kMemoryDevice: case kMemoryUnified:
         {
            ...
            for(i = 0 ; i < nsends ; i ++)
            {
               ...
               this->_recv_idx_v2[i].GatherPerm(vec_in, send_ptr);
               SCHURCHEB_MEMCPY(this->_recv_buff_v2[i], this->_recv_buff_v2_d[i], length, kMemoryHost, kMemoryDevice, T);
            }
      ...
      for(i = 0 ; i < nsends ; i ++)
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiIsend( (T*) (this->_recv_buff_v2[i]), this->_recv_idx_v2[i].GetLengthLocal(), 
                           this->_recv_from_v[i], 0, comm, &(this->_requests_v[j++])) );
      }
      
      for(i = 0 ; i < nrecvs ; i ++)
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiIrecv( (T*) (this->_send_buff_v2[i]), this->_send_idx_v2[i].GetLengthLocal(),
                           this->_send_to_v[i], 0, comm, &(this->_requests_v[j++])) );
      }
   ...
   int CommunicationHelperClass::DataTransferOverReverse(VectorVirtualClass<T> &vec_out, int loc_out)
   {
      ...
      SCHURCHEB_CHKERR(vec_out.GetLengthLocal() != this->_n_in);
         ...
         case kMemoryDevice: case kMemoryUnified:
         {
            ...
            for(i = 0 ; i < sendrecvs ; i ++)
            {
               ...
               if(idx >= nsends)
               {
                  ...
                  length = this->_send_idx_v2[idx].GetLengthLocal();
                  /* copy to device */
                  SCHURCHEB_MEMCPY(this->_send_buff_v2_d[idx], this->_send_buff_v2[idx], length, kMemoryDevice, kMemoryHost, T);
                  /* apply device permutation */
   ...
   int CommunicationHelperClass::DataTransferStart( DenseMatrixClass<T> &mat_in, int loc_in)
   {
      ...
      SCHURCHEB_CHKERR(mat_in.GetNumRowsLocal() != this->_n_in);
      ...
      switch(loc_in)
      {
         ...
         case kMemoryDevice: case kMemoryUnified:
         {
            ...
            for(i = 0 ; i < nsends ; i ++)
            {
               ...
               SCHURCHEB_MEMCPY(this->_send_buff_v2[i], this->_send_buff_v2_d[i], length*ncols, kMemoryHost, kMemoryDevice, T);
            }
      ...
      for(i = 0 ; i < nsends ; i ++)
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiIsend( (T*) (this->_send_buff_v2[i]), this->_send_idx_v2[i].GetLengthLocal()*ncols, 
                           this->_send_to_v[i], 0, comm, &(this->_requests_v[j++])) );
      }
      
      for(i = 0 ; i < nrecvs ; i ++)
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiIrecv( (T*) (this->_recv_buff_v2[i]), this->_recv_idx_v2[i].GetLengthLocal()*ncols,
                           this->_recv_from_v[i], 0, comm, &(this->_requests_v[j++])) );
      }
   ...
   int CommunicationHelperClass::DataTransferOver(DenseMatrixClass<T> &mat_out, int loc_out)
   {
      ...
      SCHURCHEB_CHKERR(mat_out.GetNumRowsLocal() != this->_n_out);
         ...
         case kMemoryDevice: case kMemoryUnified:
         {
            ...
            for(i = 0 ; i < sendrecvs ; i ++)
            {
               ...
               if(idx >= nsends)
               {
                  ...
                  length = this->_recv_idx_v2[idx].GetLengthLocal();
                  /* copy to device */
                  SCHURCHEB_MEMCPY(this->_recv_buff_v2_d[idx], this->_recv_buff_v2[idx], length*ncols, kMemoryDevice, kMemoryHost, T);
                  for(k = 0 ; k < ncols ; k ++)
                  {
                     /* apply device permutation */
   ...
   int ParallelCsrMatrixClass<T>::Setup(int nrow_local, int ncol_local, parallel_log &parlog)
   {
      ...
      SCHURCHEB_long nrow_start, ncol_start, nrow_global, ncol_global;
      ...
      SchurchebNLocalToNGlobal( nrow_local, ncol_local, nrow_start, ncol_start, nrow_global, ncol_global, comm);
   ...
   template <typename T>
   int ParallelCsrMatrixClass<T>::Setup(int nrow_local, SCHURCHEB_long nrow_start, SCHURCHEB_long nrow_global, int ncol_local, SCHURCHEB_long ncol_start, SCHURCHEB_long ncol_global, parallel_log &parlog)
   {
      this->Clear();
      ...
      SCHURCHEB_MPI_CALL( MPI_Comm_dup( comm, this->_comm));
      this->_size = np;
      this->_rank = myid;
      
      return SCHURCHEB_SUCCESS;
   }
   template int ParallelCsrMatrixClass<float>::Setup(int nrow_local, SCHURCHEB_long nrow_start, SCHURCHEB_long nrow_global, int ncol_local, SCHURCHEB_long ncol_start, SCHURCHEB_long ncol_global, parallel_log &parlog);
   template int ParallelCsrMatrixClass<double>::Setup(int nrow_local, SCHURCHEB_long nrow_start, SCHURCHEB_long nrow_global, int ncol_local, SCHURCHEB_long ncol_start, SCHURCHEB_long ncol_global, parallel_log &parlog);
   template int ParallelCsrMatrixClass<complexs>::Setup(int nrow_local, SCHURCHEB_long nrow_start, SCHURCHEB_long nrow_global, int ncol_local, SCHURCHEB_long ncol_start, SCHURCHEB_long ncol_global, parallel_log &parlog);
   template int ParallelCsrMatrixClass<complexd>::Setup(int nrow_local, SCHURCHEB_long nrow_start, SCHURCHEB_long nrow_global, int ncol_local, SCHURCHEB_long ncol_start, SCHURCHEB_long ncol_global, parallel_log &parlog);
   
   template <typename T>
   int ParallelCsrMatrixClass<T>::GetDataLocation() const
   {
      SCHURCHEB_CHKERR( this->_diag_mat.GetDataLocation() != this->_offd_mat.GetDataLocation() );
   ...
   template <typename T>
   SCHURCHEB_long ParallelCsrMatrixClass<T>::GetNumRowsGlobal() const
   {
      return this->_nrow_global;
   }
   template SCHURCHEB_long ParallelCsrMatrixClass<float>::GetNumRowsGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<double>::GetNumRowsGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexs>::GetNumRowsGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexd>::GetNumRowsGlobal() const;
   
   template <typename T>
   SCHURCHEB_long ParallelCsrMatrixClass<T>::GetNumColsGlobal() const
   {
      return this->_ncol_global;
   }
   template SCHURCHEB_long ParallelCsrMatrixClass<float>::GetNumColsGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<double>::GetNumColsGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexs>::GetNumColsGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexd>::GetNumColsGlobal() const;
   
   template <typename T>
   SCHURCHEB_long ParallelCsrMatrixClass<T>::GetRowStartGlobal() const
   {
      return this->_nrow_start;
   }
   template SCHURCHEB_long ParallelCsrMatrixClass<float>::GetRowStartGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<double>::GetRowStartGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexs>::GetRowStartGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexd>::GetRowStartGlobal() const;
   
   template <typename T>
   SCHURCHEB_long ParallelCsrMatrixClass<T>::GetColStartGlobal() const
   {
      return this->_ncol_start;
   }
   template SCHURCHEB_long ParallelCsrMatrixClass<float>::GetColStartGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<double>::GetColStartGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexs>::GetColStartGlobal() const;
   template SCHURCHEB_long ParallelCsrMatrixClass<complexd>::GetColStartGlobal() const;
   ...
   long int ParallelCsrMatrixClass<T>::GetNumNonzeros() const
   {
      ...
      if(this->_comm)
      {
         ...
         SchurchebMpiAllreduce( &nnz_local, &nnz_global, 1, MPI_SUM, *(this->_comm));
      }
   ...
   template <typename T>
   int ParallelCsrMatrixClass<T>::GetGraphArrays( vector_SCHURCHEB_long &vtxdist, vector_SCHURCHEB_long &xadj, vector_SCHURCHEB_long &adjncy)
   {
      int i, j, j1, j2;
      int np, myid;
      MPI_Comm comm;
      ...
      SCHURCHEB_MPI_CALL( SchurchebMpiAllgather( &this->_nrow_start, 1, vtxdist.GetData(), comm) );
   ...
   template int ParallelCsrMatrixClass<float>::GetGraphArrays( vector_SCHURCHEB_long &vtxdist, vector_SCHURCHEB_long &xadj, vector_SCHURCHEB_long &adjncy);
   template int ParallelCsrMatrixClass<double>::GetGraphArrays( vector_SCHURCHEB_long &vtxdist, vector_SCHURCHEB_long &xadj, vector_SCHURCHEB_long &adjncy);
   template int ParallelCsrMatrixClass<complexs>::GetGraphArrays( vector_SCHURCHEB_long &vtxdist, vector_SCHURCHEB_long &xadj, vector_SCHURCHEB_long &adjncy);
   template int ParallelCsrMatrixClass<complexd>::GetGraphArrays( vector_SCHURCHEB_long &vtxdist, vector_SCHURCHEB_long &xadj, vector_SCHURCHEB_long &adjncy);
   ...
   template <typename T>
   vector_SCHURCHEB_long& ParallelCsrMatrixClass<T>::GetOffdMap()
   {
      return this->_offd_map_v;
   }
   template vector_SCHURCHEB_long& ParallelCsrMatrixClass<float>::GetOffdMap();
   template vector_SCHURCHEB_long& ParallelCsrMatrixClass<double>::GetOffdMap();
   template vector_SCHURCHEB_long& ParallelCsrMatrixClass<complexs>::GetOffdMap();
   template vector_SCHURCHEB_long& ParallelCsrMatrixClass<complexd>::GetOffdMap();
   ...
   int ParallelCsrMatrixClass<T>::SortOffdMap()
   {
      ...
      {
         //SCHURCHEB_ERROR("Parallel CSR sort off-diagonal matrix only works on the host memory. (This function is used when setting up the matvec.)");
         //return SCHURCHEB_ERROR_MEMORY_LOCATION;
         SCHURCHEB_WARNING("Parallel CSR sort off-diagonal matrix only works on the host memory, moving data to the host. (This function is used when setting up the matvec.)");
   ...
   {
      typedef typename std::conditional<SchurchebIsDoublePrecision<T>::value, double, float>::type RealDataType;
      T local_scale;
      ...
      local_scale_real = SchurchebAbs(local_scale);
      SCHURCHEB_MPI_CALL( SchurchebMpiAllreduce( &local_scale_real, &scale_real, 1, MPI_MAX, comm) );
      scale = T(scale_real);
   ...
   int ParallelCsrMatrixClass<T>::SetupMatvecStart()
   {
      ...
      //SCHURCHEB_CHKERR(this->_comm_helper._is_waiting);
      ...
      vector_SCHURCHEB_long   send_buff_long_v, recv_buff_long_v, offd_map_vec; 
      ...
      if(this->_comm_helper._is_nbhd_built)
      {
         ...
         recv_buff_long_v.Setup(2*SchurchebMax(sends,recvs), false);
         ...
         for(i = 0 ; i < sends ; i ++)
         {
            SCHURCHEB_MPI_CALL( SchurchebMpiIsend( send_buff_long_v.GetData(), 2, this->_comm_helper._send_to_v[i], 
         ...
         for(i = 0 ; i < recvs ; i ++)
         {
            SCHURCHEB_MPI_CALL( SchurchebMpiIrecv( recv_buff_long_v.GetData()+2*i, 2, this->_comm_helper._recv_from_v[i],
         ...
         for(i = 0 ; i < sends ; i++)
         {
            SCHURCHEB_MPI_CALL( SchurchebMpiIrecv( recv_buff_long_v.GetData()+2*i, 1, this->_comm_helper._send_to_v[i],
         ...
         if(j < recvs)
         {
            ...
            SCHURCHEB_MPI_CALL( SchurchebMpiIsend( send_buff_long_v.GetData(), 1, this->_comm_helper._recv_from_v[j], 
         ...
         for(i = 0 ; i < sendrecv ; i ++)
         {
            SCHURCHEB_MPI_CALL( MPI_Waitany( sends + j, this->_comm_helper._requests_v.data(), &reqidx, MPI_STATUSES_IGNORE) );
            if(reqidx < sends)
            {
         ...
         for(i = 0 ; i < recvs ; i++)
         {
            SCHURCHEB_MPI_CALL( SchurchebMpiIsend( this->_comm_helper._idx_helper_v2[i].GetData(), this->_comm_helper._idx_helper_v2[i].GetLengthLocal(), 
                              this->_comm_helper._recv_from_v[i], myid*this->_comm_helper._recv_from_v[i], comm, &(this->_comm_helper._requests_v[reqidx++]) ) );
         }
         for(i = 0 ; i < sends ; i++)
         {
            SCHURCHEB_MPI_CALL( SchurchebMpiIrecv( this->_comm_helper._send_idx_v2[i].GetData(), this->_comm_helper._send_idx_v2[i].GetLengthLocal(), 
      ...
      else
      {
         ...
         for(i = 1 ; i < np ; i ++)
         {
             ...
             */
            SchurchebMpiSendRecv( send_buff_long_v.GetData(), 2, upid, myid*upid,
            ...
            /* send range to up */
            SCHURCHEB_MPI_CALL( SchurchebMpiIsend(&recvsize, 1, downid, myid*downid, comm, &(this->_comm_helper._requests_v[0])) );
            SCHURCHEB_MPI_CALL( SchurchebMpiIrecv(&sendsize, 1, upid, myid*upid, comm, &(this->_comm_helper._requests_v[1])) );
            if(recvsize > 0)
            {
            ...
            SCHURCHEB_MPI_CALL( MPI_Wait(this->_comm_helper._requests_v.data()+1, MPI_STATUSES_IGNORE) );
            if(sendsize > 0)
            {
            ...
            SCHURCHEB_MPI_CALL( MPI_Wait(this->_comm_helper._requests_v.data(), MPI_STATUSES_IGNORE) );
         }
   ...
   int ParallelCsrMatrixClass<T>::SetupMatvecOver()
   {
      ...
      {
         SCHURCHEB_MPI_CALL( MPI_Waitany(send_plus_recv, this->_comm_helper._requests_v.data(), &idx, MPI_STATUSES_IGNORE) );
         if(idx < recvs)
         {
   ...
   int ParallelCsrMatrixClass<T>::MatVec( char trans, const T &alpha, const VectorClass<T> &x, const T &beta, VectorClass<T> &y)
   {
      ...
      {
         SCHURCHEB_ERROR("parallel CSR matrix transport matvec not supported yet.");
         return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
      }
   ...
   {
      SCHURCHEB_ERROR("parallel CSR matrix matmat not supported yet.");
      return SCHURCHEB_SUCCESS;
   }
   ...
   template <typename T>
   int ParallelCsrMatrixClass<T>::SubMatrix(vector_SCHURCHEB_long &rows, vector_SCHURCHEB_long &cols, int location, ParallelCsrMatrixClass<T> &parcsrmat_out)
   {

#ifdef SCHURCHEB_CUDA
      if(this->GetDataLocation() == kMemoryDevice)
      {
         SCHURCHEB_ERROR("Extracting parallel csr sub-matrix only availiable on the host memory.");
         return SCHURCHEB_ERROR_MEMORY_LOCATION;
      }
      if(rows.GetDataLocation() == kMemoryDevice || cols.GetDataLocation() == kMemoryDevice)
      {
         SCHURCHEB_ERROR("Working vectors for extracting parallel csr sub-matrix can be on the host memory.");
         return SCHURCHEB_ERROR_MEMORY_LOCATION;
      }
#endif
      int                                 i, j, j1, j2, k;
      int                                 nrows_local, ncols_local, A_noffd, noffd_new, row, col;
      SCHURCHEB_long                      B_row_start, B_col_start;
      vector_SCHURCHEB_long               row_start, col_start, nCdisps, nRdisps, marker_offd;
      vector_int                          rows_local, cols_local, marker_col, marker_row;
      std::vector<vector_SCHURCHEB_long>  send_buff_vec2, recv_buff_vec2;
      ...
      vector_SCHURCHEB_long &B_offd_map      = parcsrmat_out.GetOffdMap();
      ...
      SCHURCHEB_MPI_CALL( SchurchebMpiAllgather( &(B_row_start), 1, nRdisps.GetData(), comm) );
      SCHURCHEB_MPI_CALL( SchurchebMpiAllgather( &(B_col_start), 1, nCdisps.GetData(), comm) );
      ...
      /* start communication */
      this->_comm_helper.template DataTransferStart<SCHURCHEB_long, vector_SCHURCHEB_long>(send_buff_vec2, kMemoryHost);
      ...
      this->_comm_helper.template DataTransferOver<SCHURCHEB_long, vector_SCHURCHEB_long>(recv_buff_vec2, kMemoryHost);
      ...
      std::vector<vector_SCHURCHEB_long>().swap(send_buff_vec2);
      ...
      std::vector<vector_SCHURCHEB_long>().swap(recv_buff_vec2);
      
      parcsrmat_out.MoveData(location);
      
      return SCHURCHEB_SUCCESS;
   }
   template int ParallelCsrMatrixClass<float>::SubMatrix(vector_SCHURCHEB_long &rows, vector_SCHURCHEB_long &cols, int location, ParallelCsrMatrixClass<float> &parcsrmat_out);
   template int ParallelCsrMatrixClass<double>::SubMatrix(vector_SCHURCHEB_long &rows, vector_SCHURCHEB_long &cols, int location, ParallelCsrMatrixClass<double> &parcsrmat_out);
   template int ParallelCsrMatrixClass<complexs>::SubMatrix(vector_SCHURCHEB_long &rows, vector_SCHURCHEB_long &cols, int location, ParallelCsrMatrixClass<complexs> &parcsrmat_out);
   template int ParallelCsrMatrixClass<complexd>::SubMatrix(vector_SCHURCHEB_long &rows, vector_SCHURCHEB_long &cols, int location, ParallelCsrMatrixClass<complexd> &parcsrmat_out);
   ...
   int ParallelCsrMatrixClass<T>::Transpose()
   {
      if(this->GetDataLocation() == kMemoryDevice)
      {
         SCHURCHEB_ERROR("Transpose only works on host.");
         return SCHURCHEB_ERROR_MEMORY_LOCATION;
      }
   ...
   int ParallelCsrMatrixClass<T>::Laplacian(int nx, int ny, int nz, int dx, int dy, int dz, T alphax, T alphay, T alphaz, T shift, parallel_log &parlog, bool rand_perturb)
   {
      ...
      SCHURCHEB_CHKERR( np != dx * dy * dz );
      SCHURCHEB_CHKERR(nx < dx);
      SCHURCHEB_CHKERR(ny < dy);
      SCHURCHEB_CHKERR(nz < dz);
      ...
      vector_SCHURCHEB_long   dispglobal;
      ...
      for(i = 0 ; i < np ; i ++)
      {
         ...
         ldz2   = i / dxy;
         ldy2   = (i - ldz2 * dxy) / dx;
         dispglobal[i+1] = dispglobal[i] + (SCHURCHEB_long)numxs[ldx2]*numys[ldy2]*numzs[ldz2];
      }
      ...
      /* 2D or 3D */
      two_D       = (SchurchebMin(SchurchebMin(nx, ny), nz) == 1) ? true : false;
   ...
   int ParallelCsrMatrixClass<T>::LaplacianWithPartition(int nx, int ny, int nz, int dx, int dy, int dz, int d2x, int d2y, int d2z, T alphax, T alphay, T alphaz, T shift, parallel_log &parlog, bool rand_perturb)
   {
            ...
            || (nx < d2x) || (ny < d2y) || (nz < d2z) )
      {
         if(myid == 0)
         {
            SCHURCHEB_WARNING("Invalid Laplacian parameters. Switch to default option.");
         }
   ...
   int ParallelCsrMatrixClass<T>::Helmholtz(int n, int dx, int dy, int dz, T w, parallel_log &parlog)
   {
      ...
      SCHURCHEB_CHKERR( np != dx * dy * dz );
      SCHURCHEB_CHKERR(n < dx);
      SCHURCHEB_CHKERR(n < dy);
      SCHURCHEB_CHKERR(n < dz);
   ...
   int ParallelCsrMatrixClass<T>::HelmholtzWithPartition(int n, int dx, int dy, int dz, int d2x, int d2y, int d2z, T w, parallel_log &parlog)
   {
            ...
            || (n < d2x) || (n < d2y) || (n < d2z) )
      {
         if(myid == 0)
         {
            SCHURCHEB_WARNING("Invalid Helmholtz parameters. Switch to default option.");
         }
   ...
   int ParallelCsrMatrixClass<T>::ReadFromSingleMMFile(const char *matfile, int idxin, parallel_log &parlog)
   {
      ...
      std::vector<vector_SCHURCHEB_long>  offd_maps;
      vector_int                          info;
      std::vector<vector_int>             offd_markers;
      
      if(np == 1)
      {
         err = global_coo_mat.ReadFromMMFile( matfile, idxin); SCHURCHEB_CHKERR(err);
      ...
      if(myid == 0)
      {
         ...
         for(i = 0 ; i < np ; i ++)
         {
            ...
            offd_init_guess = SchurchebMax(nrow_locals[i], ncol_locals[i]);
      ...
      if(myid == 0)
      {
         ...
         for(i = 1 ; i < np ; i ++)
         {
            ...
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( info.GetData(), 9, i, 0, comm) );
         }
         ...
         for(i = 1 ; i < np ; i ++)
         {
            ...
            info[7] = offd_coo_mats[i].GetNumNonzeros();
            info[8] = offd_maps[i].GetLengthLocal();
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( diag_coo_mats[i].GetI(), info[6], i, 0, comm) );
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( diag_coo_mats[i].GetJ(), info[6], i, 0, comm) );
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( diag_coo_mats[i].GetData(), info[6], i, 0, comm) );
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( offd_coo_mats[i].GetI(), info[7], i, 0, comm) );
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( offd_coo_mats[i].GetJ(), info[7], i, 0, comm) );
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( offd_coo_mats[i].GetData(), info[7], i, 0, comm) );
            SCHURCHEB_MPI_CALL( SchurchebMpiSend( offd_maps[i].GetData(), info[8], i, 0, comm) );
         }
         
         this->_offd_map_v.Setup(offd_maps[0].GetLengthLocal());
         
         SCHURCHEB_MEMCPY( this->_offd_map_v.GetData(), offd_maps[0].GetData(), offd_maps[0].GetLengthLocal(), kMemoryHost, kMemoryHost, SCHURCHEB_long);
         ...
         std::vector<vector_SCHURCHEB_long>().swap(offd_maps);
         std::vector<vector_int>().swap(offd_markers);
      }
      else
      {
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( info.GetData(), 9, 0, 0, comm, MPI_STATUS_IGNORE) );
         ...
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( local_diag_coo_mat.GetI(), info[6], 0, 0, comm, MPI_STATUS_IGNORE) );
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( local_diag_coo_mat.GetJ(), info[6], 0, 0, comm, MPI_STATUS_IGNORE) );
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( local_diag_coo_mat.GetData(), info[6], 0, 0, comm, MPI_STATUS_IGNORE) );
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( local_offd_coo_mat.GetI(), info[7], 0, 0, comm, MPI_STATUS_IGNORE) );
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( local_offd_coo_mat.GetJ(), info[7], 0, 0, comm, MPI_STATUS_IGNORE) );
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( local_offd_coo_mat.GetData(), info[7], 0, 0, comm, MPI_STATUS_IGNORE) );
         SCHURCHEB_MPI_CALL( SchurchebMpiRecv( this->_offd_map_v.GetData(), info[8], 0, 0, comm, MPI_STATUS_IGNORE) );
   ...
   int ParallelCsrMatrixClass<T>::PlotPatternGnuPlot( const char *datafilename, int pttype)
   {
      ...
      if(this->GetDataLocation() == kMemoryDevice)
      {
         SCHURCHEB_ERROR("Plot Pattern only works on host.");
      }
      ...
      int *offd_i = this->_offd_mat.GetI();
      int *offd_j = this->_offd_mat.GetJ();
      SCHURCHEB_long *offd_map = this->_offd_map_v.GetData();
