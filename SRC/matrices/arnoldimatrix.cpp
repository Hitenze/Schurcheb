...
namespace schurcheb
{
   ...
   {
      SCHURCHEB_WARNING("Use global comm since virtual function GetMpiInfo(int &np, int &myid, MPI_Comm &comm) not inplemented for this class.");
   ...
   {
      SCHURCHEB_WARNING("Use global comm since virtual function GetComm() not inplemented for this class.");
   ...
   {
      SCHURCHEB_ERROR("virtual function MatVec( char trans, const T &alpha, const VectorType &x, const T &beta, VectorType &y) not inplemented for this class.");
   ...
   {
      SCHURCHEB_ERROR("virtual function SetupVectorPtrStr(VectorType &v) not inplemented for this class.");
      return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
   }
