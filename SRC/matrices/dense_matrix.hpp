#ifndef SCHURCHEB_DENSE_MATRIX_H
#define SCHURCHEB_DENSE_MATRIX_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<DenseMatrixClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<DenseMatrixClass<complexd> > : public std::true_type {};
