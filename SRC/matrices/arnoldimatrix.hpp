#ifndef SCHURCHEB_ARNOLDIMATRIX_H
#define SCHURCHEB_ARNOLDIMATRIX_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<ArnoldiMatrixClass<vector_seq_complexs, complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<ArnoldiMatrixClass<vector_seq_complexd, complexd> > : public std::true_type {};
   template<> struct SchurchebIsComplex<ArnoldiMatrixClass<vector_par_complexs, complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<ArnoldiMatrixClass<vector_par_complexd, complexd> > : public std::true_type {};
