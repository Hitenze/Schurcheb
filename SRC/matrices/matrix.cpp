...
namespace schurcheb
{
   ...
   {
      SCHURCHEB_WARNING("Use default location host since virtual function GetDataLocation() not inplemented for this class.");
      return kMemoryHost;
   }
   ...
   {
      SCHURCHEB_ERROR("virtual function GetNumNonzeros() not inplemented for this class.");
   ...
   {
      SCHURCHEB_ERROR("virtual function Eye() not inplemented for this class.");
      return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
   }
   ...
   {
      SCHURCHEB_ERROR("virtual function Fill(const T &v) not inplemented for this class.");
      return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
   }
   ...
   {
      SCHURCHEB_ERROR("virtual function Scale(const T &alpha) not inplemented for this class.");
      return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
   }
   ...
   {
      SCHURCHEB_ERROR("virtual function MatVec( char trans, const T &alpha, const VectorClass<T> &x, const T &beta, VectorClass<T> &y) not inplemented for this class.");
      return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
   }
   ...
   {
      SCHURCHEB_ERROR("virtual function MatVec( char trans, const T &alpha, const VectorClass<T> &x, const T &beta, const VectorClass<T> &y, VectorClass<T> &y) not inplemented for this class.");
      return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
   }
   ...
   {
      SCHURCHEB_WARNING("NO GPU support since virtual function MoveData( const int &location) not inplemented for this class.");
      return SCHURCHEB_SUCCESS;
   }
