#ifndef SCHURCHEB_MATRIX_H
#define SCHURCHEB_MATRIX_H
...
namespace schurcheb
{
   ...
   template<> struct SchurchebIsComplex<MatrixClass<complexs> > : public std::true_type {};
   template<> struct SchurchebIsComplex<MatrixClass<complexd> > : public std::true_type {};
