#ifndef SCHURCHEB_SOLVER_H
#define SCHURCHEB_SOLVER_H
   ...
   protected:
	...
	public:
      ...
      SolverClass()
      {
         ...
         this->_is_mixed = SchurchebIsDoublePrecision<VectorType>::value != SchurchebIsDoublePrecision<DataType>::value;
         this->_matrix = NULL;
      ...
      {
         SCHURCHEB_ERROR("Error: Solve with multiple right-hand-side unimplemented for this class");
         return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
      }
      ...
      {
         SCHURCHEB_ERROR("Error: GetNumNonzeros unimplemented for this class");
         return SCHURCHEB_ERROR_FUNCTION_CALL_ERR;
      }
